...
int insere_aresta (Grafo* g,int v1, int v2){
    ...
    g->aresta[v1][v2] = 1; // COLOCA O PESO NA POSICAO g[V1][V2]
    g->aresta[v2][v1] = 1; // COLOCA O PESO NA POSICAO g[V2][V1]
...
int verifica_aresta (Grafo* g, int v1,int v2){
    ...
    if (g->aresta[v1][v2] == 1) return 1; // EXISTE ARESTA!
    else return 0; // NAO EXISTE ARESTA
}
...
int remove_aresta (Grafo* g,int v1,int v2){
    ...
    g->aresta[v2][v1] = 0; // PARA REMOVER, BASTA INSERIR 0 NA POSICAO DESEJADA!
