...
import VISUAL.SUB_VISUAL.formEventoDelete;
import VISUAL.SUB_VISUAL.formEventoInsert;

public class formEvento extends javax.swing.JFrame {
    String user;
    String password;
    
    public formEvento(String user, String password) {
        this.user = user;
    ...
    private void initComponents() {
        ...
        cinemaDelete.setText("Remover Evento");
        ...
        cinemaInsert.setText("Inserir Evento");
    ...
    private void cinemaInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cinemaInsertActionPerformed
        ...
        formEventoInsert form = new formEventoInsert(this.user, this.password); 
    ...
    private void cinemaDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cinemaDeleteActionPerformed
        ...
        formEventoDelete form = new formEventoDelete(this.user, this.password);
        form.setVisible(true);
